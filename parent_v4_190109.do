	...
	* continue, break;
	...
	forvalues n0= 13(7)69 {;
		...
		* replace birthy_prnt2 = . if prnt2==. & year==`Y';
		...
		/* 年齢 */
		local X = `Y'-1;
		replace ageprnt2 = `Y'-birthy_prnt2 if prnt2 == 1 & year==`Y' & ageprnt2==.& v`n3' ==1; /* 1月生まれ*/
		replace ageprnt2 = `X'-birthy_prnt2 if prnt2 == 1 & year==`Y' & ageprnt2==.& v`n3' !=1; 
...
forvalues Y=2017/$ly {;
	...
	forvalues n7= 3697(9)3769 {; /* 最終学歴 */
		...
		/* 配偶関係 */
		replace mar_prnt1 = 1 if prnt1==1 & v`n9'==1 & year==`Y' & mar_prnt1 ==.; /* 事実婚 */
		des v`n9', short;
		...
		replace nocntct_prnt1 = 0 if prnt1 ==1 & v`n12'==9 & year==`Y'& nocntct_prnt1==.;
		des v`n12', short;
	...
	forvalues n0= 3778(19)4044 {; /* 11～25人目 */
		local n1 = `n0'+1; /* 性別 */
		local n2 = `n0'+2; /* 生年 */
		local n3 = `n0'+3; /* 生年月 */
		local n4 = `n0'+11; /* 就職 */
		...
		* replace birthy_prnt1 = . if prnt1==. & year==`Y';
		...
		/* 就業状況 */
		replace job_prnt1_j = 1 if prnt1==1 & v`n4' ==2 & year==`Y' & job_prnt1_j==. & v`n4' <8 & v`n4' !=. ; /* 就業 */
		replace job_prnt1_j = 0 if prnt1==1 & v`n4' ==1 & year==`Y' & job_prnt1_j==. & v`n4' <8 & v`n4' !=. ; /* 非就業 */
		des v`n4', short;

	};

	forvalues n7= 3782(19)4048 {; /* 最終学歴 *//* 11～25人目 */
		local n8 = `n7'+1; /* 家族関係の変化 */
		local n9 = `n7'+3; /* 配偶関係	婚姻届を出していない */
		local n10 = `n7'+5; /* 対象者の家からかかる時間・時 */
		local n11 = `n7'+6; /* 対象者の家からかかる時間・分 */
		local n12 = `n7'+11; /* 該当するもの配偶者から連絡がつかない */
		local n13 = `n7'+12; /* 該当するもの生計が同じ */
		local n14 = `n7'+13; /* 該当するもの慢性的な日常活動の制限	 */
		local n15 = `n7'+14; /* 該当するもの要支援・要介護/障害支援	 */
	...
	forvalues n0= 4436(20)4056 {; /* 26, 27人目（2018年以降） */
		local n1 = `n0'+1; /* 性別 */
		local n2 = `n0'+2; /* 生年 */
		local n3 = `n0'+3; /* 生年月 */
		local n4 = `n0'+12; /* 就職 */
	...
	forvalues n7= 4441(20)4461 {; /* 最終学歴 *//* 26, 27人目（2018年以降） */
		local n8 = `n7'+1; /* 家族関係の変化 */
		local n9 = `n7'+3; /* 配偶関係	婚姻届を出していない */
		local n10 = `n7'+5; /* 対象者の家からかかる時間・時 */
		local n11 = `n7'+6; /* 対象者の家からかかる時間・分 */
	...
	* continue, break;
	...
	forvalues n0= 13(7)69 {;
		...
		* replace birthy_prnt2 = . if prnt2==. & year==`Y';
		...
		/* 同居 */
		replace dokyo_prnt2 =0 if  v`n0'==4 & v`n1'==1  & v`n5'==1 & year==`Y' & dokyo_prnt2 !=1; /* 男性・同居 */
		replace dokyo_prnt2 =0 if  v`n0'==4 & v`n1'==1  & v`n5'==2 & year==`Y' & dokyo_prnt2 !=1; /* 男性・別居 */
		replace dokyo_prnt2 =1 if  v`n0'==4 & v`n1'==2  & v`n5'==1 & year==`Y' & dokyo_prnt2 !=1; /* 女性・同居 */
		replace dokyo_prnt2 =0 if  v`n0'==4 & v`n1'==2  & v`n5'==2 & year==`Y' & dokyo_prnt2 !=1; /* 女性・別居 */
		des v`n5', short;

		/* 配偶状況 */
		replace mar_prnt2 = 0 if  v`n0'==4 & v`n1'==1  & v`n6'==2 & year==`Y' & mar_prnt2 != 1; /* 男性・既婚 */
		replace mar_prnt2 = 0 if  v`n0'==4 & v`n1'==1  & v`n6'==1 & year==`Y' & mar_prnt2 != 1; /* 男性・未婚 */
		replace mar_prnt2 = 1 if  v`n0'==4 & v`n1'==2  & v`n6'==2 & year==`Y' & mar_prnt2 != 1; /* 女性・既婚 */
		replace mar_prnt2 = 0 if  v`n0'==4 & v`n1'==2  & v`n6'==1 & year==`Y' & mar_prnt2 != 1; /* 女性・未婚 */
		des v`n6', short;

		/* 就業状況 */
		replace job_prnt2_j = 0 if  v`n0'==4 & v`n1'==1  & v`n4a'==2 & year==`Y' & job_prnt2_j != 1; /* 男性・就職 */
		replace job_prnt2_j = 0 if  v`n0'==4 & v`n1'==1  & v`n4a'==1 & year==`Y' & job_prnt2_j != 1; /* 男性・就職していない */
		replace job_prnt2_j = 1 if  v`n0'==4 & v`n1'==2  & v`n4a'==2 & year==`Y' & job_prnt2_j != 1; /* 女性・就職 */
		replace job_prnt2_j = 0 if  v`n0'==4 & v`n1'==2  & v`n4a'==1 & year==`Y' & job_prnt2_j != 1; /* 女性・就職していない */
		des v`n4a', short;
	...
	forvalues n7= 3697(9)3769 {; /* 最終学歴 */
		...
		/* 配偶関係 */
		replace mar_prnt2 = 1 if prnt2==1  & v`n9'==1 & year==`Y' & mar_prnt2 !=1; /* 事実婚 */
		des v`n9', short;
		...
		replace nocntct_prnt2 = 0 if prnt2 ==1 & v`n12'==9 & year==`Y'& nocntct_prnt2!=1;
		des v`n12', short;
	...
	forvalues n0= 3778(19)4044 {; /* 11～25人目 */
		...
		* replace birthy_prnt2 = . if prnt2==. & year==`Y';
		...
		/* 就業状況 */
		replace job_prnt2_j = 0 if  v`n0'==5 & v`n1'==1  & v`n4'==2 & year==`Y' & job_prnt2_j != 1; /* 男性・就職 */
		replace job_prnt2_j = 0 if  v`n0'==5 & v`n1'==1  & v`n4'==1 & year==`Y' & job_prnt2_j != 1; /* 男性・就職していない */
		replace job_prnt2_j = 1 if  v`n0'==5 & v`n1'==2  & v`n4'==2 & year==`Y' & job_prnt2_j != 1; /* 女性・就職 */
		replace job_prnt2_j = 0 if  v`n0'==5 & v`n1'==2  & v`n4'==1 & year==`Y' & job_prnt2_j != 1; /* 女性・就職していない */
		des v`n4', short;
