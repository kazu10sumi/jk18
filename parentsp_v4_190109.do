...
forvalues Y=2017/$ly {;
	...
	forvalues n7= 3697(9)3760 {; /* 最終学歴 */
		...
		/* 配偶関係 */
		replace mar_prntsp1 = 1 if prntsp1==1  & v`n9'==1 & year==`Y' & mar_prntsp1 ==.; /* 事実婚 */
		des v`n9', short;
	...
	forvalues n0= 3778(19)4044 {; /* 11～25人目 */
		...
		* replace birthy_prntsp1 = . if prntsp1==. & year==`Y';
		...
		/* 就業状況 */
		replace job_prntsp1_j = 1 if prntsp1==1 & v`n4' ==2 & year==`Y' & job_prntsp1_j==. & v`n4' <8 & v`n4' !=. ; /* 就業 */
		replace job_prntsp1_j = 0 if prntsp1==1 & v`n4' ==1 & year==`Y' & job_prntsp1_j==. & v`n4' <8 & v`n4' !=. ; /* 非就業 */
		des v`n4a', short;
	...
	* continue, break;
	...
	forvalues n0= 13(7)69 {;
		...
		* replace birthy_prntsp2 = . if prntsp2==. & year==`Y';
		...
		/* 年齢 */
		local X = `Y'-1;
		replace ageprntsp2 = `Y'-birthy_prntsp2 if prntsp2 == 1 & year==`Y' & ageprntsp2==.& v`n3' ==1; /* 1月生まれ*/
		replace ageprntsp2 = `X'-birthy_prntsp2 if prntsp2 == 1 & year==`Y' & ageprntsp2==.& v`n3' !=1; 
		des v`n3', short;
	...
	forvalues n7= 3697(9)3760 {; /* 最終学歴 */
		...
		/* 配偶関係 */
		replace mar_prntsp2 = 1 if prntsp2==1  & v`n9'==1 & year==`Y' & mar_prntsp2 !=1; /* 事実婚 */
		des v`n9', short;
	...
	forvalues n0= 3778(19)4044 {; /* 11～25人目 */
		...
		* replace birthy_prntsp2 = . if prntsp2==. & year==`Y';
		...
		/* 就業状況 */
		replace job_prntsp2_j = 0 if  v`n0'==5 & v`n1'==1  & v`n4'==2 & year==`Y' & job_prntsp2_j != 1; /* 男性・就職 */
		replace job_prntsp2_j = 0 if  v`n0'==5 & v`n1'==1  & v`n4'==1 & year==`Y' & job_prntsp2_j != 1; /* 男性・就職していない */
		replace job_prntsp2_j = 1 if  v`n0'==5 & v`n1'==2  & v`n4'==2 & year==`Y' & job_prntsp2_j != 1; /* 女性・就職 */
		replace job_prntsp2_j = 0 if  v`n0'==5 & v`n1'==2  & v`n4'==1 & year==`Y' & job_prntsp2_j != 1; /* 女性・就職していない */
		des v`n4', short;
